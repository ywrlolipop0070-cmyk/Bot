...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "farhan") || (event.body.toLowerCase() == "farhan vai") || (event.body.toLowerCase() == "@farhan") || (event.body.toLowerCase() == "ফারহান")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Farhan ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Farhan.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/share/19nv6CzgdM/\nতার সাতে যোগা যোগ করবেন WhatsApp :- ০১৯৭৭*****৪", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator: FARHAN ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস ফারহান আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Farhan ッ❤️ তাকে সবাই ফারহান নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@La Miya") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস ফারহান এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Lamiya") || (event.body.toLowerCase() == "Nusrat")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস ফারহান এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@alpha") || (event.body.toLowerCase() == "lamiya")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস ফারহান এর জান এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Shamim chowdhury") || (event.body.toLowerCase() == "shamim")) {
     return api.sendMessage("🥰-shamim -🌺 আমার বস ফারহানের বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>Eity kitty chat bot", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "rotna") || (event.body.toLowerCase() == "apu")) {
   ...
   if ((event.body.toLowerCase() == "ami farhan") || (event.body.toLowerCase() == "kire")) {
